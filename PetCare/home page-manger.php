...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="homePageStyle-manger.css">
      ...
      <div class="grid-about-us">
        <div class="card">
          <div class="card-content">
            <h1 class="card-header"><strong>ABOUT US</strong><a href="home%20page-manger-editAboutUS.php" class="edit-about">Edit</a></h1>
              <img src="<?php echo $photo ?>">
            <p class="card-text">
                <?php echo $description ; ?>
                <!--"Pet Care" was founded in February 2022. Our clinic is the first in its class in the Kingdom of Saudi Arabia, Since it was established, our staff have been providing unique veterinary medical services and compassionate animal care in Riyadh city-->
      ...
      <div class="swiper-wrapper content">
       ...
       if ($result) {
           ...
           while ($data = mysqli_fetch_row($result)) {
               ...
               Print "<div class='swiper-slide cardR'><div class='card-contentR'><div class='image'><img src='".$dataOwner[2]."' alt='profilePic'></div><div class='name-profession'><span class='name'>".$dataOwner[0]." ".$dataOwner[1]."</span><span class='profession'>".$data[0]."</span></div><p class='line'>ــــــــــــــــــــــــــــــــــــ</p><div class='rating'><span class='Rnote'>".$data[1]."</span><br><span class='Rnote'>".$dataApp[1]."</span></div></div></div>";   
