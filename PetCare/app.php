...
$rr=mysqli_fetch_assoc($result2);
             ...
             print(" <form method='POST' action='#' ><div class='card'>
              ...
              <img src='$immmg' alt='pet picture' class='pet-pic' name= 'imgPet'>
             <div class='pet-data'>
             <h5>Pet Name:</h5>
...
$apponum=$row['appoNum'];
             ...
             ".$row['note']."</p>
                         ...
                         <div class='pet-data'>
                                ...
                                <label><input name='rating' type='radio' 4'Bad'>Bad </label>
                            </div>
                                
                               <div class='pet-data' >
                                <h5>Any Additional Notes:</h5>
                              <textarea rows='3' cols='28' style='width: 198px; height: 103px;' name='review'></textarea>
                            </div><input type='submit' value='Submit' class='button' name='Submit' onclick='addReview(".$row['appoNum'].")'>
...
die( "<p>Could not open URL database</p>" );
 ...
 $queryCheck="SELECT `appoNum` FROM `review`";                           
...
document.getElementById('msgAdd').innerHTML("Review has been sent seccussfully!");
            }
