...
<html>
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data" class="test">
          ...
          $query="select Fname,Lname,profilePhoto,phoneNumber from petowner WHERE email='".$Email."'";  
...
if(isset($_POST['update'])){
  ...
  move_uploaded_file($photo_tmp_name, 'profile_img/'.$photo_name);
    ...
    $sql="UPDATE petowner SET Fname='$FName',Lname='$LName',phoneNumber='$phn',profilePhoto='$photo_name' WHERE email='".$_SESSION['email']."'";
